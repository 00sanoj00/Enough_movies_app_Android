package com.sanoj.devildeveloper.enoughmovies.webview;
...
import com.sanoj.devildeveloper.enoughmovies.Utility.ImageCaptureHelper;
import com.sanoj.devildeveloper.enoughmovies.Utility.LocationUtility;
...
public class AdvancedWebView extends WebView   {
	...
	public interface OnScrollListener {
		void onScrollChanged(AdvancedWebView AdvancedWebView, int x, int y, int oldx, int oldy);
	}
